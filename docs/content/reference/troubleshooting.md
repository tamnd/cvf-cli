...
Most of these come down to network reality or how cvf serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cvf rate-limits like any public site. cvf already paces
...
Where a surface is gated, cvf reads a cookie or token you supply
...
`cvf`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cvf actually did
